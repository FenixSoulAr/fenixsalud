...
import { Loader2, RefreshCw, CheckCircle2, AlertTriangle, XCircle, Users, Building2, Paperclip } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {lang === "es"
              ? "Diagnóstico de integridad y consistencia del modelo de datos"
              : "Data model integrity and consistency diagnostics"}
          </p>
        </div>
                  ...
                  {["points_to_inactive_professional", "null_id_but_assigned", "has_id_but_not_assigned"].map(
                    (issueType) => {
                      ...
                      const issueLabels: Record<string, { es: string; en: string }> = {
                        points_to_inactive_professional: {
                          es: "Apunta a profesional inactivo",
                          en: "Points to inactive professional",
                        },
                        null_id_but_assigned: {
                          es: "Sin profesional pero estado = assigned",
                          en: "No professional but status = assigned",
                        },
                        has_id_but_not_assigned: {
                          es: "Con profesional pero estado ≠ assigned",
                          en: "Has professional but status ≠ assigned",
                        },
                      };
                      return (
                        <div key={issueType}>
