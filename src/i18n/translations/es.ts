...
export const es: Translations = {
  ...
  settings: {
    ...
    proActive: "Estás en el plan Pro. ¡Gracias por tu apoyo!",
  ...
  emergency: {
    buttonLabel: 'Emergencia',
    modalTitle: 'Información de emergencia',
    modalSubtitle: 'Datos críticos que pueden salvarte la vida',
    onboardingMessage: 'Esta información es vital ante una emergencia médica. Los campos marcados con ★ son los más importantes.',
    critical: 'Crítico',
    bloodType: 'Grupo sanguíneo',
    selectBloodType: 'Seleccionar...',
    bloodTypeUnknown: 'No sé',
    emergencyPhone: 'Teléfono de emergencia',
    emergencyPhonePlaceholder: 'Ej: 911 / +54 11 1234-5678',
    allergies: 'Alergias',
    allergiesPlaceholder: 'Ej: penicilina, mariscos, látex...',
    allergiesSuggestions: ['Penicilina', 'Aspirina', 'Mariscos', 'Maní', 'Látex', 'Polen'],
    insuranceProvider: 'Obra social',
    insurancePlan: 'Plan',
    insuranceMemberId: 'N° de afiliado',
    edit: 'Editar',
    save: 'Guardar',
    close: 'Cerrar',
    cancel: 'Cancelar',
    dismissForNow: 'Después',
